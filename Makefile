baseline:
	nsml run -d ppy --memory 20G --shm-size 20G -e ./code/train.py -g 1 -c 20 -a "--n-labeled 10 --data-path /data/ppy/train/ --batch-size 8 --epochs 20"
...
mixtext:
	nsml run -d ppy --memory 20G --shm-size 20G -e ./code/train.py -g 1 -c 20 -a "--n-labeled 10 --data-path /data/ppy/train/ --batch-size 4 --batch-size-u 8 --epochs 20 --val-iteration 1000 \
